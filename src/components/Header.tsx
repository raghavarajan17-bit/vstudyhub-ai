...
import { 
  ...
  Calculator, BrainCircuit, HelpCircle, Trophy, Layers, Filter, User, Award, Shield, Newspaper, MessageSquareText
} from 'lucide-react';
...
{ id: 'ai-interview', label: 'AI Interview', icon: MessageSquareText, badge: 'GLOBAL' },
